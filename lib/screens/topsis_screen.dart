...
import '../utils/topsis_calculator.dart';
import '../widgets/topsis/input.dart';
import '../widgets/topsis/output.dart';

class TopsisScreen extends StatefulWidget {
  const TopsisScreen({super.key});

  @override
  State<TopsisScreen> createState() => _TopsisScreenState();
}

class _TopsisScreenState extends State<TopsisScreen>
  ...
  void _calculateTopsis() async {
    ...
    try {
      ...
      final calculator = TopsisCalculator();
      final result = await calculator.calculate(
        matrix: decisionMatrix,
        weights: weights.map((e) => e / 100).toList(),
  ...
  Widget _buildCalculateButton(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: isLoading ? null : _calculateTopsis,
...
class _HeaderSubtitle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final screen = context.findAncestorStateOfType<_TopsisScreenState>();
