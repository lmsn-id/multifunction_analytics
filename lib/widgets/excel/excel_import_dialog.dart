...
class ExcelImportDialog extends StatefulWidget {
  final Function(Map<String, dynamic> data) onImport;

  const ExcelImportDialog({super.key, required this.onImport});
...
class _ExcelImportDialogState extends State<ExcelImportDialog> {
  ...
  void _confirmImport() {
    try {
      ...
      final data = ExcelService.prepareDataFromFiltered(_filteredData);
